      ...
      <div className="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
        <div className="flex flex-wrap items-center justify-between">
          ...
          <div className="flex mt-3 sm:mt-0">
            <select id="filter" name="filter" className="mt-1 block pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-[#2e9d74] focus:border-[#2e9d74] sm:text-sm rounded-md" value={filter} onChange={e => setFilter(e.target.value as TaskStatus | 'all')}>
